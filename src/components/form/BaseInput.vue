...
const inputClasses = computed(() => {
	...
	return [...baseClasses, sizeClasses[props.size], variantClasses[props.variant], errorClasses];
});

const labelClass = computed(() => {
	return props.variant === "default" ? "block text-sm font-medium text-gray-700 mb-1" : "sr-only";
});
